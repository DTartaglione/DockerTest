...
namespace Event_Consumer
{
    class Event_Consumer_Globals
    {
        ...
        public static Dictionary<string, StoredEventData> dictEventIDMap = new Dictionary<string, StoredEventData>();
        public static Dictionary<int, EventClassLookup> dictEventClassLookup = new Dictionary<int, EventClassLookup>();
        public static Dictionary<int, FacilityLookup> dictFacilityData = new Dictionary<int, FacilityLookup>();
        public static Dictionary<int, NodeLookup> dictNodeData = new Dictionary<int, NodeLookup>();
        public static Dictionary<int, DirectionLookup> dictDirectionData = new Dictionary<int, DirectionLookup>();
        public static Dictionary<int, ArticleLookup> dictArticleData = new Dictionary<int, ArticleLookup>();
        ...
        public static XmlDocument GetXMLFromSimulationFile(string sXmlDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Event_Consumer_Globals.GetXMLFromSimulationFile()");
        ...
        public static string GetJsonFromSimulationFile(string sJsonDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Event_Consumer_Globals.GetJsonFromSimulationFile()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
                sJsonResp = "";
            }
        ...
        public static Boolean DoGZIP(string sOutFile)
        {
            ...
            {
                LogFile.LogErrorText("Error in Event_Consumer_Globals.DoGZIP()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
            }
        ...
        public static int SetAgencyID(string sAgencyName)
        {
            ...
            if (Event_Consumer_Globals.dictAgencyInfo.ContainsValue(sAgencyName))
            {
                foreach (KeyValuePair<int, string> kvpAgency in Event_Consumer_Globals.dictAgencyInfo)
                {
