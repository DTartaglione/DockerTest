...
namespace CCTV_Consumer
{
    class CCTV_Consumer_Globals
    {
        ...
        public static Dictionary<string, StoredCCTVData> dictStoredCCTV = new Dictionary<string, StoredCCTVData>();
        ...
        public static XmlDocument GetXMLFromSimulationFile(string sXmlDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in CCTV_Consumer_Globals.GetXMLFromSimulationFile()");
        ...
        public static string GetJsonFromSimulationFile(string sJsonDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in CCTV_Consumer_Globals.GetJsonFromSimulationFile()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
                sJsonResp = "";
            }
        ...
        public static Boolean DoGZIP(string sOutFile)
        {
            ...
            {
                LogFile.LogErrorText("Error in CCTV_Consumer_Globals.DoGZIP()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
            }
        ...
        public static int SetAgencyID(string sAgencyName)
        {
            ...
            if (CCTV_Consumer_Globals.dictAgencyInfo.ContainsValue(sAgencyName))
            {
                foreach (KeyValuePair<int, string> kvpAgency in CCTV_Consumer_Globals.dictAgencyInfo)
                {
