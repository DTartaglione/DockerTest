...
AS $function$
	...
	BEGIN
		    ...
		    --Added logic to store top row in historical table. We know if source_id is 1 it is the next hour of weather.
		    IF (_source_id = '1')
		    THEN
		    	IF NOT EXISTS (SELECT 1 FROM historicds.tblweatherhourly WHERE start_time = _start_time)
		    	THEN
