...
namespace Aviation_DI
{
    class Aviation_DI_Globals
    {
        ...
        //Settings
        //public static string sAviationOutFile = "";
        //public static string sAviationDeleteListFile = "";
        //public static string sCopyAviationBatFile = "";
        //public static int iDefaultDirectionID = 0;
        //public static string sAviationOutDirectory = "";

        //app hash tables and dictionaries
        public static Dictionary<int, string> dictAgencyInfo = new Dictionary<int, string>();
        public static Dictionary<string, string> dictFlightsToArchive = new Dictionary<string, string>();
        public static Dictionary<string, Aviation_DI_StoredFlightData> dictStoredFlightData = new Dictionary<string, Aviation_DI_StoredFlightData>();
        ...
        public static Timer tmGetFlights = new Timer();
        ...
        public static void ReadConfigParams()
        {
            ...
            //sAviationOutFile = ConfigurationManager.AppSettings["AviationOutFile"];
            //sAviationDeleteListFile = ConfigurationManager.AppSettings["AviationDeleteListFile"];
            //sCopyAviationBatFile = ConfigurationManager.AppSettings["CopyAviationBatFile"];
            //iDefaultDirectionID = Convert.ToInt16(ConfigurationManager.AppSettings["DefaultDirectionID"]);
            //sAviationOutDirectory = ConfigurationManager.AppSettings["AviationOutDirectory"];
        ...
        public static XmlDocument GetXMLFromSimulationFile(string sXmlDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Aviation_DI_Globals.GetXMLFromSimulationFile()");
        ...
        public static string GetJsonFromSimulationFile(string sJsonDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Aviation_DI_Globals.GetJsonFromSimulationFile()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
                sJsonResp = "";
            }
        ...
        public static Boolean DoGZIP(string sOutFile)
        {
            ...
            {
                LogFile.LogErrorText("Error in Aviation_DI_Globals.DoGZIP()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
            }
        ...
        public static int SetAgencyID(string sAgencyName)
        {
            ...
            if (Aviation_DI_Globals.dictAgencyInfo.ContainsValue(sAgencyName))
            {
                foreach (KeyValuePair<int, string> kvpAgency in Aviation_DI_Globals.dictAgencyInfo)
                {
