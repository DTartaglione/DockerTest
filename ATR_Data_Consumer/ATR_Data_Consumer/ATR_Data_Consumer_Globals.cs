...
{
    class ATR_Data_Consumer_Globals
    {
        ...
        public static Dictionary<int, Sensor> dictSensors = new Dictionary<int, Sensor>();
        public static Dictionary<string, int> dictSensorMapping = new Dictionary<string, int>();
        ...
        public static XmlDocument GetXMLFromSimulationFile(string sXmlDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in ATR_Data_Consumer_Globals.GetXMLFromSimulationFile()");
        ...
        public static string GetJsonFromSimulationFile(string sJsonDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in ATR_Data_Consumer_Globals.GetJsonFromSimulationFile()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
                sJsonResp = "";
            }
        ...
        public static Boolean DoGZIP(string sOutFile)
        {
            ...
            {
                LogFile.LogErrorText("Error in ATR_Data_Consumer_Globals.DoGZIP()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
            }
        ...
        public static int SetAgencyID(string sAgencyName)
        {
            ...
            if (ATR_Data_Consumer_Globals.dictAgencyInfo.ContainsValue(sAgencyName))
            {
                foreach (KeyValuePair<int, string> kvpAgency in ATR_Data_Consumer_Globals.dictAgencyInfo)
                {
