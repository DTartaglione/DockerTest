...
AS $function$
      ...
      declare _stop_time_arr_event_id int := 0;
      declare _stop_time_dep_event_id int := 0; 
	  ...
	  begin
	      ...
	      return _stop_time_update_id;
      end;
$function$
;

-- 005 - new SP sp_getgtfsvehiclepositions
...
-- 006 - new SP sp_getgtfstripupdates
