...
{
    class Video_Detection_Consumer_Globals
    {
        ...
        //Device details
        public static int iSensorZoneDeviceTypeID = 0;
        public static int iSensorZoneDeviceSubtypeID = 0;

        //app hash tables and dictionaries
        public static Dictionary<int, string> dictAgencyInfo = new Dictionary<int, string>();
        public static Dictionary<string, SensorZone> dictSensorZones = new Dictionary<string, SensorZone>();
        ...
        public static void ReadConfigParams()
        {
            ...
            //device details
            iSensorZoneDeviceTypeID = Convert.ToInt16(ConfigurationManager.AppSettings["SensorZoneDeviceTypeID"]);
            iSensorZoneDeviceSubtypeID = Convert.ToInt16(ConfigurationManager.AppSettings["SensorZoneDeviceSubtypeID"]);
        ...
        public static XmlDocument GetXMLFromSimulationFile(string sXmlDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Video_Detection_Consumer_Globals.GetXMLFromSimulationFile()");
        ...
        public static string GetJsonFromSimulationFile(string sJsonDoc)
        {
            ...
            {
                LogFile.LogErrorText("Error in Video_Detection_Consumer_Globals.GetJsonFromSimulationFile()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
                sJsonResp = "";
            }
        ...
        public static Boolean DoGZIP(string sOutFile)
        {
            ...
            {
                LogFile.LogErrorText("Error in Video_Detection_Consumer_Globals.DoGZIP()");
                LogFile.LogErrorText(ex.ToString());
                LogFile.LogError(ex);
            }
        ...
        public static int SetAgencyID(string sAgencyName)
        {
            ...
            if (Video_Detection_Consumer_Globals.dictAgencyInfo.ContainsValue(sAgencyName))
            {
                foreach (KeyValuePair<int, string> kvpAgency in Video_Detection_Consumer_Globals.dictAgencyInfo)
                {
